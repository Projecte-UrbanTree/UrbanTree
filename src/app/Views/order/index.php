            ...
            <?php foreach ($orders as $order): ?>
                <?php foreach ($order->tasks() as $task): ?>
                    <tr class="border-b hover:bg-gray-100">
                        ...
                        <td class="py-2 px-4">
                            <button class="bg-green-500 hover:bg-green-600 text-white font-semibold py-1 px-2 rounded mr-2"
                                onclick="window.location.href='/order/<?php echo $order->getId(); ?>'">
                                Editar
                            </button>

                            <form action="/order/<?php echo $order->getId(); ?>" method="DELETE">
