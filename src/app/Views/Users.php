            ...
            <?php foreach ($users as $user) { ?>
                <tr class="hover:bg-blue-50">
                    <td class="px-4 py-3 border-b">
                        <?php echo htmlspecialchars($user->__get('id')); ?>
                    </td>
                    <td class="px-4 py-3 border-b">
                    ...
                    <td class="px-4 py-3 border-b text-center flex justify-center space-x-4">
                        ...
                        <a href="/user/<?php echo htmlspecialchars($user->__get('id')); ?>/edit"
                        ...
                        <a href="/user/<?php echo htmlspecialchars($user->__get('id')); ?>/delete"
