...
<div class="bg-white p-8 border border-gray-300 rounded-lg shadow-md">
    ...
    <form
        ...
        <!-- Zone_ip -->
        <div>
            <label for="zone_id" class="block text-sm font-medium text-gray-700 mb-1">Zone_id</label>
        ...
        <!-- Tree Type id -->
        <div>
            <label for="tree_type_id" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
