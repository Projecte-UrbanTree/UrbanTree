<div>
    <form action="/incidence/<?php echo htmlspecialchars($incidence->getId()); ?>/update" method="post">
        <div>
        ...
        <div class="mt-6">
            ...
            <textarea
                ...
                class="border-2 border-gray-300 rounded-md p-3 mt-1 w-full h-32 focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-sm resize-none"
                disabled><?php echo htmlspecialchars($incidence->description); ?></textarea>
        </div>
        ...
        <div class="flex justify-end gap-4 mt-6">
            ...
            <button id="btn-modify" onclick="modifyIncidence()" class="bg-green-500 hover:bg-green-600 hover:scale-105 duration-200 text-white font-medium py-2 px-5 rounded-lg shadow focus:outline-none focus:ring focus:ring-green-400">
                Modificar
            </button>
