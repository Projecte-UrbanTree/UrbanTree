        ...
        <tbody>
            <?php foreach ($users as $user) { ?>
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-5 py-4">
                        <?php echo htmlspecialchars($user->getRoleName($user->role)); ?>
                    </td>
                    <td class="flex items-center px-5 py-4 space-x-4">
                        <a href="/admin/user/<?php echo htmlspecialchars($user->getId()); ?>/edit"
                        ...
                        <a href="/admin/user/<?php echo htmlspecialchars($user->getId()); ?>/delete"
                            onclick="return confirm('¿Desea eliminar el usuario <?php echo htmlspecialchars($user->name . ' ' . $user->surname); ?>?');"
