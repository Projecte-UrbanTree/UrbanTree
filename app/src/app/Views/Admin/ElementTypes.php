        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 border-b text-center flex space-x-4">
                    ...
                    <a href="/admin/element-type/<?php echo htmlspecialchars($elementType->getId()); ?>/edit"
                    ...
                    <a href="/admin/element-type/<?php echo htmlspecialchars($elementType->getId()); ?>/delete"
