    ...
    <form id="typeResourcesForm" action="/admin/resource-type/<?= htmlspecialchars($resource_type->getId()); ?>/update"
        ...
        <div>
            ...
            <textarea id="description" name="description"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500"><?= htmlspecialchars($resource_type->description); ?></textarea>
        </div>
