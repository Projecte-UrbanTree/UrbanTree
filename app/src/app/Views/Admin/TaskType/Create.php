<div class="mb-4 flex justify-end">
    <a href="/task-types"
        ...
        <span>Return to Task Types</span>
    </a>
</div>

<div class="bg-white p-8 border border-gray-300 rounded-lg shadow-md">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Create TaskType</h2>
    <form action="/task-types/store" method="POST" class="space-y-6">
