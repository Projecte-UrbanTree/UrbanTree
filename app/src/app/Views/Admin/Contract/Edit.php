...
<div class="bg-white p-8 border border-gray-300 rounded-lg shadow-md">
    ...
    <form id="contractForm" action="/admin/contract/<?= htmlspecialchars($contract->getId()); ?>/update" method="POST"
        ...
        <div class="col-span-1 md:col-span-2 flex justify-end gap-4">
            <button type="submit"
                class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white shadow-sm rounded-lg focus:outline-none focus:ring focus:ring-blue-500">
                Actualizar
            </button>
            <button type="button"
                class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white shadow-sm rounded-lg focus:outline-none focus:ring focus:ring-red-500">
                Eliminar
            </button>
        </div>
    </form>
